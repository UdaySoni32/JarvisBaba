...
class JarvisTUI:
    ...
    def print_help(self):
        ...
        table.add_row("", "")
        table.add_row("[bright_yellow]create goal: <desc> [priority <1-10>]", "[yellow]Create a new goal")
        table.add_row("list goals", "Show all active goals")
        table.add_row("complete goal <id>", "Mark goal as completed")
        table.add_row("", "")
        table.add_row("[bright_green]autonomy off|suggest|assist|full", "[green]Set autonomy mode")
        table.add_row("autonomy status", "Show current mode and recent decisions")
        table.add_row("list approvals", "Show pending task approvals")
        table.add_row("approve <task_id>", "Approve a pending task")
        table.add_row("reject <task_id> [reason]", "Reject a pending task")
        table.add_row("", "")
